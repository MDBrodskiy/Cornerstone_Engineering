...
\includepdf[pages=-]{Figures/Contract.pdf}
...
\includepdf[pages=-,angle=90]{Figures/EncryptionGameCollapsed.pdf}
\includepdf[pages=-,angle=90]{Figures/EncryptionGameSketch.pdf}
...
\includepdf[pages=-]{Figures/Gantt.pdf}
